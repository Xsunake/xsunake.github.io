...
~~_**此文章为初版，于2024年3月22日更新，还有很多东西就先占个坑，敬请期待**_~~

**首先，作为GAL爱好者，当然是能支持正版就支持正版了**，买正版GAL的途径有
<a href="https://www.dlsite.com" target="_blank">DLsite</a> 、 <a href="https://www.getchu.com" target="_blank">Getchu</a>、 <a href="https://store.steampowered.com" target="_blank">Steam</a>，推荐搭配<a href="https://vndb.org" target="_blank">视觉小说资料库</a>使用，具体使用文档可以参照<a href="https://bbs.kfpromax.com/read.php?tid=991471&sf=717" target="_blank">这个</a>
...
|KRKR版|<a href="https://github.com/zeas2/Kirikiroid2" target="_blank">Kirikiroid2模拟器</a>是一款目前比较流行的GAL模拟器，可以在手机上运行GAL，支持运行kirikiri引擎的游戏，不过现在更流行运行KRKR版本的游戏，通过各种操作可以用PC端的GAL制作出KRKR版，现在的资源网站基本上都会标注好哪些游戏是KR版(IOS上App Store的xp3player就是KRKR模拟器，不过要钱)|
|ONS版|<a href="http://onsplayer.cn/info/2321" target="_blank">ONS模拟器</a>也是一款能在手机上运行GAL的模拟器，ONS版的游戏才能在这上面运行，资源网站也会标注好哪些是ONS版(IOS上App Store中就叫ONS，也要钱)|
...
2. <a href="https://zodgame.xyz/" target="_blank">ZodGame</a>(已墙，且关闭注册，姑且放在这里吧)

3. <a href="https://www.erogame.space/" target="_blank">ファウスト旧作図録</a>(需要邀请码，不适合萌新使用)

4. <a href="https://www.sayhuahuo.xyz/" target="_blank">花火学院</a>(<a href="https://www.sayhuahuo.net" target="_blank">这是备用域名</a>，为什么把它放这么前，是因为它的页游花火链接真的很牛逼，难以想象一个二次元论坛能做出内容如此丰富的JRPG)
...
7. <a href="https://bbs2.kdays.net/" target="_blank">KDays论坛</a>

8. <a href="https://bbs.sumisora.net/" target="_blank">澄空学园</a>

9. <a href="https://www.vikacg.com/post" target="_blank">维咔VikACG</a>

10. <a href="https://zi0.cc/" target="_blank">梓澪の妙妙屋</a>

11. <a href="https://www.mikocon.com/" target="_blank">Mikocon</a>(都是日文，不推荐萌新使用)

12. <a href="https://www.yngal.com/" target="_blank">初音的青葱</a>(<a href="https://xygalgame.com/" target="_blank">发布页</a>)

13. <a href="https://www.touchgal.org/" target="_blank">TouchGAL

14. <a href="https://www.shinnku.com/" target="_blank">失落の小站</a>

15. <a href="https://lzacg.org/" target="_blank">量子ACG</a>

16. <a href="https://rosmontis.com/" target="_blank">Rosmontis&迷迭香的博客</a>(这个网站的首页看不到GAL资源，顶部搜索框还点不出来，可以在网站后加上"/search/想搜的东西"，比如说"https://rosmontis.com/search/柚子"，就可以搜索柚子相关帖子)

17. <a href="https://sakustar.top/" target="_blank">稻荷ACG</a>

18. <a href="https://t-satoru.top/" target="_blank">小鳥遊暁の会员制餐厅</a>(一个GAL移植大佬，很多GAL的KR版或安卓版都是他移植的)

19. <a href="https://galgamer.moe/" target="_blank">Galgamer</a>

20. <a href="https://pan.jlbx.xyz/GalGame" target="_blank">姬路白雪の资源小站</a>

21. <a href="https://ggbases.dlgal.com/" target="_blank">GGBases</a>(磁力资源，<a href="https://gitlab.com/ggbases/address" target="_blank">这是发布页</a>)

22. <a href="https://pan.cangshui.net/" target="_blank">沧水的网盘</a>(主要为ONS资源，密码是god，<a href="https://cangshui.net/" target="_blank">这是站长的博客</a>)

23. <a href="https://galgame5.rssing.com/chan-51243512/index-latest.php" target="_blank">喵窝</a>(各种从<a href="https://anime-sharing.com" target="_blank">AS</a>上搬运到OD盘和MEGA盘的游戏，没什么比较知名的游戏)

24. <a href="https://www.galgameacgjohn.top/">galgame藏经阁</a>(这个网站在2024年3月份才出来，截止至3月22日资源还是非常之少)
...
<h4><a href="https://github.com/zeas2/Kirikiroid2" target="_blank">Kirikiroid2模拟器</a>使用方法</h4>
...
由于KR模拟器已经于2018年停止更新，随着时间的推移，一些新版本的手机系统可能已经无法正常运行KR模拟器，这时可以使用Tyranor模拟器(在较老的32位处理器手机上，要使用 Tyranor 的 1.5.6 版本，否则会无法安装，但虽然动态立绘功能将无法使用)。Ty模拟器内置了KR引擎，相当于自带一个KR模拟器，并且它支持现在新版本的手机系统，可以代替KR模拟器。并且还能模拟其他各种类型的游戏，功能十分强大。只需把游戏文件放到<code>/手机存储/tyranor</code>这个目录就行。

### ONS类

ONS模拟器使用起来也很简单，<a href="http://onsplayer.cn/info/2321" target="_blank">这是官网的教程</a>，在ONS中打开游戏文件夹就能直接运行。
...
1. <a href="https://github.com/cx2333-gt/GalTransl" target="_blank">GalTransl</a>

2. <a href="https://github.com/Lilyltt/GalUpTs/tree/GalUpTs1.3.0" target="_blank">GalUpTs</a>

# 补充

## QQ群中apk文件的问题

现阶段QQ群中后缀为apk的安装包上传后后缀都会变成"apk.1"，我们需将文件下载之后打开文件目录：/手机储存/Android/data/com.tencent.mobileqq/Tencent/QQfile_recv/，将你下载的文件后缀改回"apk"，就可以进行安装了
...
新兴的123云盘因为免费用户空间大，不限速而受到了很多人的青睐，用它做分享的也越来越多，但用它分享GAL的也不是很多，如果加密措施做的不到位，比如只压缩一层，就容易被封，连分卷压缩都能被封。
...
想把磁链转成Torrent可以用<a href="https://magnet2torrent.com" target="_blank">Magnet >> Torrent</a>，输入磁链就可以得到对应的Torrent文件，下载即可。

最后说句最重要的：

**<font color=red>不</font><font color=orange>要</font><font color=yellow>使</font><font color=green>用</font><font color=blue>吸</font><font color=indigo>血</font><font color=purple>雷</font>!!!<font color=red>不</font><font color=orange>要</font><font color=yellow>使</font><font color=green>用</font><font color=blue>吸</font><font color=indigo>血</font><font color=purple>雷</font>!!!<font color=red>不</font><font color=orange>要</font><font color=yellow>使</font><font color=green>用</font><font color=blue>吸</font><font color=indigo>血</font><font color=purple>雷</font>!!!**

重要的事情说三遍，迅雷就是在破坏国内BT下载的环境，真的不能用。

## GitHub使用基础教程

此篇文章很多工具都是在<a href="https://github.com" target="_blank">GitHub</a>上的开源工具，但是在国内访问GitHub会有很多困难，有时能打开网站，有时不能，下载速度更是慢到让人难以忍受，**当然，如果你会翻墙，就可以不用往下看了**。
...
首先，让我们明确一点：**<font color=yellow>GALGAME绝大多数都是R18，也就是工口游戏，称其为黄油也没什么问题，绝不是什么能上得了台面的的东西(虽然很多电视节目都喜欢用GAL的配乐)，作为旮旯玩家不要去大肆宣扬，不要让各种鱼龙混杂的人进入圈子</font>**

从根本上来说，华语GAL圈是个充斥着盗版的地方，这点已经很难改变，都说着业界药丸，但中国人基本上没有给GAL厂商做过任何贡献(除了柚子社和前翼社这样的厂商)，这其中当然有很多原因，但还是希望能支持正版就支持一下吧。
